...
@section('content')
    <a href="{{ route('students.index') }}" class="cursor-pointer text-sm text-neutral-500 hover:text-neutral-700">← Students</a>
    ...
    <form method="POST" action="{{ route('students.store') }}" class="mt-6 max-w-2xl space-y-6">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('students.index') }}" class="cursor-pointer text-sm font-medium text-neutral-500 hover:text-neutral-700">Cancel</a>
        </div>
    </form>
@endsection
